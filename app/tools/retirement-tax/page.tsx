...
const faqs = [
  ...
  {
    question: "退職金の税金は、いくらからかかりますか（かからない金額）？",
    answer:
      "退職金が退職所得控除の額以下なら、所得税・住民税はかかりません。控除額は勤続20年までが「40万円×勤続年数（最低80万円）」、20年超は「800万円＋70万円×(勤続年数−20年)」です。例えば勤続10年なら400万円、勤続20年なら800万円、勤続30年なら1,500万円までは非課税です。これを超えた部分の1/2に課税されます。",
  },
  {
    question: "「退職所得の受給に関する申告書」を出さないとどうなりますか？",
    answer:
      "この申告書を勤務先に提出していれば、退職所得控除を反映した正しい税額が源泉徴収され、原則として確定申告は不要です。未提出だと退職金の額面に一律20.42%の所得税が源泉徴収されるため、多くの場合は払い過ぎになり、確定申告での還付が必要になります。",
  },
];

...
const faqs = [
  ...
  {
    question: "フリーランスの税金はいくらから発生しますか？",
    answer:
      "所得税は、所得（売上−経費）から基礎控除48万円などの所得控除を引いた「課税所得」がプラスになると発生します。年間所得48万円以下なら所得税はかかりません（住民税は自治体により概ね45万円前後から）。また事業所得が年20万円を超える副業などは確定申告が必要です。実際の税額は、上のシミュレーターに売上と経費を入れて確認してください。",
  },
];

export const metadata: Metadata = {
  title:
    "フリーランス 税金シミュレーション｜手取り・所得税・住民税・国保を無料計算",
  description,

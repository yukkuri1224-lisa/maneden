...
export default async function TakeHomeLevelPage({
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: `${TAX_YEAR}年度の税制・協会けんぽの全国平均的な料率をもとにした概算です。加入する健康保険や都道府県、各種控除により実額は変わります。正確な金額は給与明細や勤務先の担当部署でご確認ください。`,
    },
  ];
  ...
  return (
    <Container className="py-10">
      ...
      <p className="mt-3 max-w-2xl text-muted-foreground">
        年収{level.man}
        万円（額面・独身・扶養なし・協会けんぽの全国平均料率）の場合、社会保険料・所得税・住民税を差し引いた手取りの目安と、その内訳を解説します。
      </p>
      ...
      <div className="mt-14 space-y-12">
        ...
        >
          <p>
            本ページは{TAX_YEAR}
            年度の税制・協会けんぽの全国平均的な料率をもとにした、独身・扶養なし・40歳未満の会社員の概算です。加入する健康保険・都道府県・各種控除により実額は異なります。
          </p>
          <p className="mt-1">
            計算根拠：
            <a
